...
def sort_price():
    ...
    if rpo:
        ...
        rpo_conditions = {
            ...
            "WBL": ["v.model = 'CAMARO'", "v.trim NOT IN ('ZL1', '1LS')", "c.color_name IN ('BLACK', 'SUMMIT WHITE', 'SHARKSKIN METALLIC', 'SATIN STEEL GRAY METALLIC')", "opt.option_code IN ('WBL', 'CG6', 'VUP', '3F9', '2F5')"],
