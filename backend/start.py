...
def sort_price():
    ...
    if rpo:
        ...
        rpo_conditions = {
            ...
            "USA": ["model IN ('CORVETTE STINGRAT', 'CORVETTE Z06', 'CORVETTE E-RAY', 'CORVETTE ZR1', 'CORVETTE ZR1X')", "modelYear = '2026'", "trim IN ('3LT', '3LZ')", "(color_name = 'ARCTIC WHITE' OR color_name = 'BLACK')"],
